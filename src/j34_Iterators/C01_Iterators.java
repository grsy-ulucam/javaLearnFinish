...
public class C01_Iterators {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < l1.size(); i++) {
            System.out.println("l1.get(i) = " + l1.get(i) + " ");// Nur Gamze Erol Bekir
         ...
         */
            ...
            while (it1.hasNext()) ;
            {
                ...
                System.out.println(it1.next() + " ");//Nur :-)  Gamze :-)  Erol :-)  Bekir :-)
            }
            System.out.println();
            System.out.println("   *** Iterators ***   ");
            ...
            ListIterator<String>it3=l3.listIterator();//tekrar iterator yapısı tanımlandı
              ...
              while (it1.hasNext()){
                  it3.set(it1.next()+":-)") ;//tekrardaki next() ile elemanı  :-) concat ederk update edilidi
              }
