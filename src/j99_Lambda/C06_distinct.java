...
public class C06_distinct {
    ...
    public static void alfBkTkszPrint(List<String> menu) {
        ...
        menu.stream().map(String::toUpperCase).sorted().
                distinct().
...
// Task : list elelmanlarinin character sayisini ters sirali olarak tekrarsiz print ediniz..
    ...
    public static void chrSysTersSıraPrint(List<String> menu) {
        menu.stream().map(String::length).//akısdaki string elemalr karakter sayısına update edildi
                sorted(Comparator.reverseOrder()).distinct().//tekrarsız
                forEach(t -> System.out.print(t + ""));
    }

    // Task : List elemanlarini character sayisina gore kckten byk e gore print ediniz...
    public static void chrSysBkSıraPrint(List<String> menu) {
        menu.stream().sorted(Comparator.comparing(String::length)).//akısdaki string elemanların lenght'ine göre doğal sıra yapıldı
                forEach(t -> System.out.print(t + " "));
    }
