...
public class C01_HashSet {
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            System.out.println("hs1.addAll(hs2) = " + hs1.addAll(hs2));//[null, Basarı, Ercan, Adem, Kevser, Asıktır, Nur, Yakup, Rukiye, Gayrete ]
            ...
            System.out.println("hs2.contains(\"javaNAZZ\") = " + hs2.contains("javaNAZZ"));//false
