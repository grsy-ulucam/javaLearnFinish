...
public class C03_ClassCastException {
    public static void main(String[] args) {
        ...
        String str = (String) obj;//object data type String data type casting yapılarak atandıSystem.out.println("str = " + str);// javaCAN'lara selam olsun
